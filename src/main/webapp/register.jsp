	...
	<form action="${pageContext.request.contextPath }/user/register" method=post>
		<div class="wrap" id="wrap">
			<div class="logGet">
				...
				<!-- 输入框 -->
				<div class="lgD">
					<img src="img/qq.png" width="20" height="20" alt="" /> 
					<input name=code type="text" placeholder="输入工号" />
				</div>
				<div class="lgD">
					<img src="img/qq.png" width="20" height="20" alt="" /> 
				...
				<div class="lgD">
					<img src="img/contact.png" width="20" height="20" alt="" /> 
					<input name=idtype type="text" placeholder="输入用户类型" />
				</div>

				<div class="logC" style="margin: 25px">
					<a  target="_self"><button>注册</button></a>
				</div>
